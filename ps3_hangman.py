# Hangman game
# If unfamiliar about the hangman game, read all about it at https://en.wikipedia.org/wiki/Hangman_(game)
...
# The Game
# The function includes calls to input to get the user's guess.    
